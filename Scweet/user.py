...
def get_users_following(users, verbose=1, headless=True, wait=2, limit=float('inf'), file_path=None):

    following = utils.get_users_follow(users, headless, "following", verbose, wait=wait, limit=limit)
